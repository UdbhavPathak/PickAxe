...
class Game:
    def __init__(self,fullscreen = False):
        ...
        self.player1.angle = math.radians(180)
        ...
        self.camera_static = bool(int(self.gamedata[3]))
        ...
        while self.running:
            ...
            if not self.game_over:
                ...
                if self.camera_static:
                    ...
                    targetcenter = [(self.window.get_width()//2)*self.scale,(self.window.get_height()//2)*self.scale]
